...
function calculateRowProduct(matrix, initialRow, initialCol) {
  let product = 1;

  for (let i = 0; i < 4; i++) {
    product *= matrix[initialRow][initialCol + i];
  }

  return product;
}

function calculateColProduct(matrix, initialRow, initialCol) {
  let product = 1;

  for (let i = 0; i < 4; i++) {
    product *= matrix[initialRow + i][initialCol];
  }
...
function greatestProduct(matrix) {
  ...
  for (let i = 0; i <= matrix.length - 4; i++) {
    ...
    for (let j = 0; j <= row.length - 4; j++) {
      max = Math.max(
        max,
        calculateRowProduct(matrix, i, j),
        calculateColProduct(matrix, i, j)
      );
    }
  }
